...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Image view to show the picture the user has taken
        ...
        findViewById<Button>(R.id.btnSubmit).setOnClickListener{
            ...
            if(photoFile!=null){
               ...
               Toast.makeText(this,"Please take a picture before submitting", Toast.LENGTH_SHORT).show()
            }

        }

        findViewById<Button>(R.id.btnTakePicture).setOnClickListener {
            // launch camera to let user take pictures
            onLaunchCamera()
        }
    ...
    fun submitPost(description: String, user: ParseUser, file: File){
        ...
        post.saveInBackground { exception ->
            if(exception !=null){
                Log.i(TAG, "Error while saving post")
                exception.printStackTrace()

            }else{
                Log.i(TAG, "Successfully saved post")
                //let user know the post is saved
